class Job < ActiveRecord::Base
  ...
  validates_length_of :title, :maximum => 50, :unless => Proc.new{|u| u.attributes['title'].blank?}
  validates_length_of :city, :maximum => 50, :unless => Proc.new{|u| u.attributes['city'].blank?}
  validate :valid_date
